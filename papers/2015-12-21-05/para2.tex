...
\[
I=\{\ \{U_{1},U_{2},\cdots,U_{n+1}\}\ |\ \mbox{$\{U_{1},U_{2},\cdots,U_{n+1}\}\subset \mathcal{U}$で$U_{1},U_{2},\cdots,U_{n+1}$は互いに異なる}\}
\]
と定義し、$T\in I$に対して
\[
...
$deg(x;\mathcal{U})=n+1$のとき：ちょうど$n+1$個の$\mathcal{U}$の元$U_1,U_2,\cdots,U_{n+1}$が$x$を含む。$S=\{U_1,U_2,\cdots,U_{n+1}\}\in I$と置けば、$A_T$の定義から
