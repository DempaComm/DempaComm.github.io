...
\]
\[
\le \int_a^b|K_n(y)||f(c+x-y)-f(x)|dy=\int_{|c-y|<\delta}|K_n(y)||f(c+x-y)-f(x)|dy+\int_{|c-y|\ge \delta}|K_n(y)||f(c+x-y)-f(x)|dy
\]
ここで最後の式の初項について一様連続性から
\[
\int_{|c-y|<\delta}|K_n(y)||f(c+x-y)-f(x)|dy<\frac{\varepsilon}{2C}\int_{|c-y|<\delta}|K(y)|\ dy\le\frac{\varepsilon}{2C}C=\frac{\varepsilon}{2}
\]
第二項について
\[
