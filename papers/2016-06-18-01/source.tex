...
写像
\[
\mathord{a\ast}\colon G\rightarrow G,\quad x\mapsto ax,\qquad \mathord{\ast b}\colon G\rightarrow G,\quad x\mapsto xb
...
$\mathfrak{M}$の元のうち、$f^{-1}((d,1])$の形のものはそのままでよくて、$f^{-1}([0,a))$の形の集合は連続写像
\[
g=1-f:X\rightarrow [0,1]
\]を考えれば、$g^{-1}((1-a,1])=f^{-1}([0,a))$となると表される。$f^{-1}((b,c))$の集合の修正は面倒くさい。まず任意の$s\in f^{-1}((b,c))$をとり、そして$f(s)=r$とおくと$r\in (b,c)$である。そして連続写像
\[
h;X\rightarrow [0,1]
