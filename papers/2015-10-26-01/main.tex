...
\]を充たすとするこのとき、
\[
\left.\frac{d}{dt}\right|_{t=a}\int_X f(x,t)\ d\mu(x)=\int_X \frac{\partial f}{\partial t}(x,a)\ d\mu(x)
\]
\end{thm}
\begin{proof}
\[
...
であり、
\[
\lim_{h\to 0}\frac{F(a+h)-F(a)}{h}=\left.\frac{d}{dt}\right|_{t=a}\int_X f(x,t)\ d\mu(x)
\]
なので定理がわかる。
\end{proof}
