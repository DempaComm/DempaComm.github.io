...
交わらない２つの閉集合$E,F$について$f|E\equiv 0,\ f|F\equiv 1$となる連続関数$f:X\to [0,1]$について、$U=f^{-1}([0,1/2)),\ V=f^{-1}((1/2,1])$を考えれば$U,V$は互いに交わらない開集合で$E\subset U,\ F\subset V$なので結局$(2)\To (1)$が成り立つ。
\end{proof}
